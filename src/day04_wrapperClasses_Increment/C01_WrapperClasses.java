...
public class C01_WrapperClasses {
    public static void main(String[] args) {
        ...
        // Java primitive data turleri icin de istedigimiz zaman
        // method kullanabilmemize imkan vermek amaci ile
        // Wrapper Class'lari olusturmustur.

        // Blooean, Character, Byte, Short, Integer, Long, Float ve Double
        ...
        System.out.println("Verilen String sayilarin toplami : " + (sayi1inDegeri + sayi2inDegeri)); // 307
